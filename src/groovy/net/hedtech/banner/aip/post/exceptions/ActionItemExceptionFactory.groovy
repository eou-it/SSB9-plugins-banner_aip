...
class ActionItemExceptionFactory {
    ...
    public static ApplicationException createApplicationException( Class service, Throwable t, String errorCode ) {
        ApplicationException ae = new ActionItemApplicationException( service, t )
    ...
    public static ApplicationException createFriendlyApplicationException( Class service, String errorCode, String resourceId ) {
        ApplicationException ae = new ActionItemApplicationException( service, "@@r1:${resourceId}@@" )
        ae.friendlyName = errorCode
        return ae
    }
     ...
     * @param parameter0 the first parameterized value which will be passed as the {0} of the string value
     */
    public static ApplicationException createFriendlyApplicationException( Class service, ActionItemErrorCode errorCode, String resourceId, String
            parameter0 ) {
        ApplicationException ae = new ActionItemApplicationException( service, "@@r1:${resourceId}:${parameter0}@@" )
