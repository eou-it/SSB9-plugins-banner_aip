 ...
 */
class BlockingProcessUrls implements Serializable {
     ...
     * @return
     */
    static def fetchUrlsForSpecificProcess( processId ) {
        BlockingProcessUrls.withSession {session ->
            session.getNamedQuery( 'BlockingProcessUrls.fetchUrlsForSpecificProcess' )
