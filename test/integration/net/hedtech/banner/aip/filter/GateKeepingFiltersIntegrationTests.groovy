...
class GateKeepingFiltersIntegrationTests extends BaseIntegrationTestCase {
    ...
    void testConfiguredLookupRedirectLocation() {
        setGORICCR( 'Y' )
        String configuredBase = net.hedtech.banner.general.ConfigurationData.fetchByNameAndType(
    ...
    private void setGeneralAppLocation( String value ) {
        ...
        assertEquals( value, net.hedtech.banner.general.ConfigurationData.fetchByNameAndType( 'GENERALLOCATION', 'string', 'GENERAL_SS' )
                .value )
    }
